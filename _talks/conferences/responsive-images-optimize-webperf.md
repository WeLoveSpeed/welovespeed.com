...
en_US:
  title: "Optimize performance by optimizing the dimensions of responsive images."
  description: >-
    The use of standards for responsible images (mainly `srcset-w`) has become an imperative, but is not always followed by a comprehensive analysis of their proper use.


    To be more specific: too many sites use arbitrary image sizes in their `srcset-w`s, neglecting a significant performance optimization possibility.
