...
fr_FR:
  ...
  description: >-
    ...
    Enfin, nous ferons un tour d'horizon de futures APIs très prometteuses en cours de développement au sein du groupe de travail Web Performance du W3C et partageront notre retour d'expérience sur celles-ci, les ayant testés récemment sur Wikipédia dans le cadre d'Origin Trials de Chrome.
  slides: ~
  video: ~
en_US:
