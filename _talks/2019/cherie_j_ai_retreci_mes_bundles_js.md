...
fr_FR:
  ...
  description: >-
    Sur un site à destination de conseillers d'une grande banque, nous nous sommes heurtés à des problèmes de performance dûs à la quantité de JavaScript que nous envoyions au client.
    ...
    J'illustrerai ces sujets avec les impacts concrets de chacune des ces méthodes sur la performance de mon projet.
