...
namespace :postbuild do
  ...
  namespace :test do
    ...
    task :kiss do
      sh 'htmlproofer ./_site --disable-external --url-ignore "#,https://www.weezevent.com/?c=sys_widget,/en/legal-mentions/,/2019/cfp,/en/2019/cfp,/en/2019/informations/" --empty-alt-ignore true'
    end
